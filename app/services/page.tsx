    ...
    <>
      <section className="pt-32 sm:pt-40 pb-12 sm:pb-16 text-center bg-white">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-slate-500 text-base sm:text-lg mt-6 leading-relaxed">Every service is rooted in engineering discipline, design thinking, and a relentless focus on outcomes.</p>
        </div>
      </section>
      <Services />
      <CTA />
